...
class DagReasoningSystem:
    ...
    def initial_plan(self):
        ...
        type = get_query_category(self.metadata['type'])
        examples = retrieval_dag_examples_with_expr(question_vector, f'metadata["type"] == "{type}"',
                                                    self.plan_examples_collection_name)
...
# store_path = '/data1/zch/MultiModelDocRag/generate_augment/query_plan/prediction_qwen2_vl_72b_dev_v2.jsonl'
# store_path = '/data1/zch/MultiModelDocRag/generate_augment/query_plan/prediction_qwen2_vl_72b_dev_v3.jsonl'
