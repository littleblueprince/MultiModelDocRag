...
from util.retrieval_api import cosine_similarity
import requests
...
store_path = './dev_dag_query_qwen2vl_72b_few_shots.jsonl'
...
for item in tqdm(data):
    ...
    examples = retrieval_dag_examples(query_vector, collection_name='dag_v1')
    messages = get_dag_query_prompt_v1(question=question, examples=examples)
